import { createViewCodeNamedThemes, VIEWCODE_NAMED_THEME_IDS } from "./viewcodeThemes.ts";
...
const VIEWCODE_LIGHT_COLORS: ThemeColors = {
  canvas: "#FAFAFA",
  chrome: "#EDEDEF",
  toolbar: "#FAFAFA",
  toolbarForeground: "#262626",
  toolbarBorder: "rgb(0 0 0 / 0.06)",
  toolbarControl: "#FFFFFF",
  toolbarControlForeground: "#2E2E2E",
  toolbarControlHover: "#F2F2F3",
  surface: "#FAFAFA",
  surfaceRaised: "#FFFFFF",
  surfaceOverlay: "#F7F7F8",
  text: "#262626",
  textMuted: "#7D7D7D",
  ...
  placeholder: "#A0A0A0",
  secondaryLabel: "#7D7D7D",
  iconMuted: "#8C8C8C",
  error: "#C4392F",
  errorForeground: "#B3261E",
  errorSurface: "rgb(196 57 47 / 0.08)",
  warning: "#7E6A00",
  warningForeground: "#6B5A00",
  warningSurface: "rgb(126 106 0 / 0.10)",
  update: "#9A5714",
  updateForeground: "#9A5714",
  ...
  sidebarMutedForeground: "#7A7A7C",
  sidebarControlSurface: "rgb(0 0 0 / 0.06)",
  sidebarRowHover: "rgb(0 0 0 / 0.05)",
  sidebarRowActive: "rgb(0 0 0 / 0.08)",
  sidebarRowSelected: "rgb(0 0 0 / 0.10)",
  sidebarBorder: "rgb(0 0 0 / 0)",
  terminalBackground: "#FBFBFB",
  terminalForeground: "#262626",
  terminalCursor: "#9A5714",
  terminalSelection: "rgb(62 92 136 / 0.18)",
  terminalScrollbar: "rgb(0 0 0 / 0.14)",
...
export const VIEWCODE_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    chrome: "#1F1F21",
    toolbar: "#19191B",
    toolbarForeground: "#DEDEDF",
    toolbarBorder: "rgb(255 255 255 / 0.06)",
    toolbarControl: "rgb(255 255 255 / 0.07)",
    toolbarControlForeground: "#E6E6E7",
    toolbarControlHover: "rgb(255 255 255 / 0.11)",
    surface: "#19191B",
    ...
    iconMuted: "#8A8A8C",
    error: "#E5675F",
    errorForeground: "#F08A83",
    errorSurface: "rgb(229 103 95 / 0.12)",
    warning: "#C9B037",
    warningForeground: "#DCC86A",
    warningSurface: "rgb(201 176 55 / 0.12)",
    update: "#E0A15A",
    updateForeground: "#EDBE84",
    ...
    sidebar: "#1F1F21",
    sidebarForeground: "#DEDEDF",
    sidebarMutedForeground: "#9A9A9B",
    sidebarControlSurface: "rgb(255 255 255 / 0.06)",
    sidebarRowHover: "rgb(255 255 255 / 0.05)",
    sidebarRowActive: "rgb(255 255 255 / 0.08)",
    sidebarRowSelected: "rgb(255 255 255 / 0.10)",
    sidebarBorder: "rgb(255 255 255 / 0)",
    terminalBackground: "#141414",
    terminalForeground: "#DEDEDF",
    terminalCursor: "#E0A15A",
    terminalSelection: "rgb(138 162 196 / 0.28)",
    terminalScrollbar: "rgb(255 255 255 / 0.12)",
    terminalScrollbarHover: "rgb(255 255 255 / 0.20)",
  },
  variants: {
    light: VIEWCODE_LIGHT_COLORS,
  },
};
