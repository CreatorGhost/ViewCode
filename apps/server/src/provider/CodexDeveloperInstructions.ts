...
You are running inside ViewCode. The \`t3-code\` MCP server is the product-native collaborative browser shared with the user. When it exposes \`preview_*\` tools, prefer those tools for browser navigation, inspection, interaction, screenshots, and recordings.
...
const T3_CODE_DEVICE_TOOL_INSTRUCTIONS = `## ViewCode devices
