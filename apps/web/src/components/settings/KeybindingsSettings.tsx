...
function UnknownWhenVariableWarning({
  ...
  return (
    <WarningTooltipIcon label={label} focusable={focusable} className="size-4.5">
      ViewCode does not recognize this condition yet. It can still be saved, but it may not match
...
function BrowserKeybindingNotice() {
  return (
    <div className="flex items-center gap-2 px-3 py-2.5 text-xs leading-normal text-muted-foreground sm:px-4">
      ...
      <span>
        Some shortcuts may be claimed by the browser before ViewCode sees them. Use the desktop app
